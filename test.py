...
#    print "clacShift", calcShift(out)
    ...
    d = feature.sift(lena1, lena2, lena1, lena2, lena1, lena2, lena1, lena2, verbose=0)
    for i in d:
        print i, "clacShift", calcShift(d[i])
#        for j in range(min(5, d[i].shape[0])):
#            print d[i][j]
#        print

#        Visual((lena1, lena2, lena1)[i[0]], (lena1, lena2, lena1)[i[1]], d[i])
